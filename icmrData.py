...
class IcmrData:
	...
	def display_record_id(self):
		print('Total New Records', len(list(filter(
			lambda data: data['record_id'] == '', self.record_data['rec_collected']))))
		print('Total Already Exist Records', len(list(filter(
			lambda data: data['record_id'] != '', self.record_data['rec_collected']))))
...
if __name__ == '__main__':
	...
	pid = ['C316818AA', 'C316819', 'C316820', 'C316821', 'C316822', 'C316823', 'C316824', 'C316825', 'C316826', 'C316827',
		   'C316828', 'C316829', 'C316830', 'C316831', 'C316832', 'C316833', 'C316834', 'C316835', 'C316836', 'C316837', 'C316838']
	icmr = IcmrData()
